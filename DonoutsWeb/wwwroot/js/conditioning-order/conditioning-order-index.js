function loadSavedDataOA() {
    ...
    let CloseOrderUserName = $("#FirstSignature").val()
    let CloseOrderUserDateString = $("#FirstSignatureDate").val()
    let CloseOrderUserDate = !isNullOrEmpty(CloseOrderUserDateString) ? new Date(CloseOrderUserDateString) : null
    $('#CloseSignature').html(getSignature(CloseOrderUserName, CloseOrderUserDate))
